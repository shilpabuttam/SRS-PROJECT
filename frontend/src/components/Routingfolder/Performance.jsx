...
function Performance() {
  return (
    <div className='text-dark'>
      <h1>performance 1</h1>
      <p>The words each, every, either, and neither are distributives. Distributives are determiners that are used to talk about how something is shared out or divided.
...
For further information on English Grammar,
